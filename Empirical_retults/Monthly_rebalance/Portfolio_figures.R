...
date<-prices$Dates
date<-as.Date.factor(date[-c(1:500)], format="%Y-%m-%d")
date_monthly<-as.Date.factor(date[(0:(floor((1862-500)/22)-1))*22+1], format="%Y-%m-%d")
...
png(file = pngname, width=750, height=600, bg = "transparent")
boxplot(w_network_vary_with_phi_Dantzig[[1]][61,])
dev.off()

pngname<-paste0(getwd(),"/weight_boxplot/GLASSO_2_constraint_network_",1,"_lastday_.png")
png(file = pngname, width=750, height=600, bg = "transparent")
boxplot(w_network_vary_with_phi_glasso[[1]][61,])
dev.off()

pngname<-paste0(getwd(),"/weight_boxplot/PlugIn_2_constraint_network_",1,"_lastday_.png")
png(file = pngname, width=750, height=600, bg = "transparent")
boxplot(w_network_vary_with_phi[[1]][61,])
dev.off()

for (i in 1:9) {
  
  pngname<-paste0(getwd(),"/weight_boxplot/PlugIn_3_constraint_network_",i,"_.png")
  png(file = pngname, width=750, height=600, bg = "transparent")
  boxplot(w_network_vary_with_phi_3constraint[[i]], xaxt = "n")
  # boxplot(w_network_vary_with_phi[[i]])
  dev.off()
}
...
for (i in 1:9) {
  ...
  pngname<-paste0(getwd(),"/weight_boxplot/Dantzig_3_constraint_network_",i,"_.png")
  png(file = pngname, width=750, height=600, bg = "transparent")
  boxplot(w_network_vary_with_phi_3constraint_Dantzig[[i]], xaxt = "n")
  dev.off()
}

for (i in 1:9) {
  
  pngname<-paste0(getwd(),"/weight_boxplot/GLASSO_3_constraint_network_",i,"_.png")
  png(file = pngname, width=750, height=600, bg = "transparent")
  boxplot(w_network_vary_with_phi_3constraint_glasso[[i]], xaxt = "n")
  dev.off()
}
...
pngname<-paste0(getwd(),"/weight_boxplot/Dantzig_2_constraint_network_",1,"_lastday_.png")
png(file = pngname, width=750, height=600, bg = "transparent")
boxplot(w_network_vary_with_phi_3constraint_Dantzig[[1]][61,])
dev.off()

pngname<-paste0(getwd(),"/weight_boxplot/GLASSO_2_constraint_network_",1,"_lastday_.png")
png(file = pngname, width=750, height=600, bg = "transparent")
boxplot(w_network_vary_with_phi_3constraint_glasso[[1]][61,])
dev.off()

pngname<-paste0(getwd(),"/weight_boxplot/PlugIn_2_constraint_network_",1,"_lastday_.png")
png(file = pngname, width=750, height=600, bg = "transparent")
boxplot(w_network_vary_with_phi_3constraint[[1]][61,])
dev.off()
...
nega.weights.plugin.3constraint=c()
for (t in 1:61) {
  nega.weights.plugin.3constraint[t]=sum(w_network_vary_with_phi_3constraint[[1]][t,]<0)
}
negative_weights<-zoo(data.frame(nega.weights.plugin.3constraint),
                      order.by=as.Date(as.character(date_monthly), format="%Y-%m-%d"))
pngname<-paste0(getwd(),"/nega_weight/PlugIn_3_constraint_network_",1,"_lastday_.png")
png(file = pngname, width=750, height=600, bg = "transparent")
plot(negative_weights, xlab = "Time", ylab = "Number of negative weights")
# axis(1,cex.axis = 3)
dev.off()

nega.weights.Dantzig.3constraint=c()
for (t in 1:61) {
  nega.weights.Dantzig.3constraint[t]=sum(w_network_vary_with_phi_3constraint_Dantzig[[1]][t,]<0)
}
negative_weights<-zoo(data.frame(nega.weights.Dantzig.3constraint),
                      order.by=as.Date(as.character(date_monthly), format="%Y-%m-%d"))
pngname<-paste0(getwd(),"/nega_weight/Dantzig_3_constraint_network_",1,"_lastday_.png")
png(file = pngname, width=750, height=600, bg = "transparent")
plot(negative_weights, xlab = "Time", ylab = "Number of negative weights")
dev.off()

nega.weights.glasso.3constraint=c()
for (t in 1:61) {
  nega.weights.glasso.3constraint[t]=sum(w_network_vary_with_phi_3constraint_glasso[[1]][t,]<0)
}
negative_weights<-zoo(data.frame(nega.weights.glasso.3constraint),
                      order.by=as.Date(as.character(date_monthly), format="%Y-%m-%d"))
pngname<-paste0(getwd(),"/nega_weight/glasso_3_constraint_network_",1,"_lastday_.png")
png(file = pngname, width=750, height=600, bg = "transparent")
plot(negative_weights, xlab = "Time", ylab = "Number of negative weights")
dev.off()
