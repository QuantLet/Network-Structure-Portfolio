...
# In this file, 1.we add 3-constraint network

rm(list = ls())

# setwd("E:/BaiduSyncdisk/Network_structure_based_portfolio/Dantzig-selector estimation covariance/Monthly_rebalance_20230418")
...
xtable(rbind(cbind(cumureturn_minVar[n]/n*252*100,
                   ...
                   cumureturn_network_vary_with_phi_Dantzig[[1]][n]/n*252*100,
                   cumureturn_network_vary_with_phi_glasso[[1]][n]/n*252*100,
                   cumureturn_network_vary_with_phi_2constraint[[9]][n]/n*252*100,
                   cumureturn_network_vary_with_phi_2constraint_Dantzig[[1]][n]/n*252*100,
                   cumureturn_network_vary_with_phi_2constraint_glasso[[1]][n]/n*252*100),
             cbind(std(return_minVar)*sqrt(252)*100,
                   std(return_meanVar)*sqrt(252)*100,
                   std(return_equal)*sqrt(252)*100,
                   std(return_network_vary_with_phi[[1]])*sqrt(252)*100,
                   std(return_network_vary_with_phi_Dantzig[[1]])*sqrt(252)*100,
                   std(return_network_vary_with_phi_glasso[[1]])*sqrt(252)*100,
                   std(return_network_vary_with_phi_2constraint[[9]])*sqrt(252)*100,
                   std(return_network_vary_with_phi_2constraint_Dantzig[[1]])*sqrt(252)*100,
                   std(return_network_vary_with_phi_2constraint_glasso[[1]])*sqrt(252)*100),
             cbind(cumureturn_minVar[n]/n*252/(std(return_minVar)*sqrt(252))*100,
                   cumureturn_meanVar[n]/n*252/(std(return_meanVar)*sqrt(252))*100,
                   cumureturn_equal[n]/n*252/(std(return_equal)*sqrt(252))*100,
                   cumureturn_network_vary_with_phi[[1]][n]/n*252/(std(return_network_vary_with_phi[[1]])*sqrt(252))*100,
                   cumureturn_network_vary_with_phi_Dantzig[[1]][n]/n*252/(std(return_network_vary_with_phi_Dantzig[[1]])*sqrt(252))*100,
                   cumureturn_network_vary_with_phi_glasso[[1]][n]/n*252/(std(return_network_vary_with_phi_glasso[[1]])*sqrt(252))*100,
                   cumureturn_network_vary_with_phi_2constraint[[9]][n]/n*252/(std(return_network_vary_with_phi_2constraint[[9]])*sqrt(252))*100,
                   cumureturn_network_vary_with_phi_2constraint_Dantzig[[1]][n]/n*252/(std(return_network_vary_with_phi_2constraint_Dantzig[[1]])*sqrt(252))*100,
                   cumureturn_network_vary_with_phi_2constraint_glasso[[1]][n]/n*252/(std(return_network_vary_with_phi_2constraint_glasso[[1]])*sqrt(252))*100),
             cbind(maxDrawdown(return_minVar-1),
                   maxDrawdown(return_meanVar-1),
                   maxDrawdown(return_equal-1),
                   maxDrawdown(return_network_vary_with_phi[[1]]-1),
                   maxDrawdown(return_network_vary_with_phi_Dantzig[[1]]-1),
                   maxDrawdown(return_network_vary_with_phi_glasso[[1]]-1),
                   maxDrawdown(return_network_vary_with_phi_2constraint[[9]]-1),
                   maxDrawdown(return_network_vary_with_phi_2constraint_Dantzig[[1]]-1),
                   maxDrawdown(return_network_vary_with_phi_2constraint_glasso[[1]]-1)),
             cbind(p_turnover(w_minVar),
                   p_turnover(w_meanVar),
                   p_turnover(w_equal),
                   p_turnover(w_network_vary_with_phi[[1]]),
...
sort(col_sums(w_network_vary_with_phi_2constraint[[1]]),decreasing = T)[1:5]
sort(col_sums(w_network_vary_with_phi_2constraint_Dantzig[[1]]),decreasing = T)[1:5]
# CHD      PNW       KR      BLK      NEM 
sort(col_sums(w_network_vary_with_phi_2constraint_glasso[[1]]),decreasing = T)[1:5]
