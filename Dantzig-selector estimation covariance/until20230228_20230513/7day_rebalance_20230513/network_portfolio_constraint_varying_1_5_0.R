# network_portfolio version 1.6.0

# Comparing version 1.5.0
#
# In this file,  we use data from 2016-01-04 to 2023-02-28
...
setwd("~/同步空间/Network_structure_based_portfolio/Dantzig-selector estimation covariance/until20230131_20230513/7day_rebalance_20230513")
...
# rolling window
W<-list()
for(t in 0: (floor((1858-1-500)/7)-1)){
  W[[(t+1)]]=returnstd[(1+t*7):(507+t*7),]
}
W_in<-list()
W_out<-list()
for(t in 0: (floor((1858-1-500)/7)-1)){
  W_in[[(t+1)]]=W[[t+1]][c(1:500),]
  W_out[[(t+1)]]=W[[t+1]][c(501:507),]
}
T.windows<-length(W)
