# network_portfolio version 1.6.1

# Comparing version 1.5.1
#
# In this file,  we use data until 2023-02-28
#
#                   change date forrmat to '%Y-%m-%d'

rm(list = ls())

setwd("~/同步空间/Network_structure_based_portfolio/Dantzig-selector estimation covariance/until20230228_20230513/5day_rebalance_20230513")
